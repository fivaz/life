...
import { NUMBER_OF_CELLS } from './calendar-grid/service.svelte';
import type { EventsGrid } from './event-panel/placement-service';
import { getEventSlots } from './event-panel/placement-service';
