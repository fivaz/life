<script lang="ts">
	...
	const colors = {
		...
		white:
			'focus-visible:outline-white-600 hover:bg-gray-200 dark:hover:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100',
	...
	const basic =
		'flex items-center gap-2 rounded-md text-sm font-semibold shadow-2xs focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2';
</script>
