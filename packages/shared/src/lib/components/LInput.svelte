...
<label
	class="{klass} flex gap-0.5 text-sm font-medium {disabled
		? 'text-gray-500'
...
>
	...
	{/if}
	<input
		class="{inputClass} block rounded-md border-gray-300 p-2 shadow-2xs focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:border-white/10 dark:bg-white/5 dark:scheme-dark"
