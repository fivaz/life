...
<button
	class={classnames(
		colors[color],
		'inline-flex gap-2 justify-center rounded-md px-3 py-1.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
		className,
	)}
	{type}
	{formaction}
