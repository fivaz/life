	...
	<div class="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full" style="width: 165%">
		...
		>
			<div class="grid grid-cols-7 text-sm leading-6 text-gray-500 sm:hidden">
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
					M <span class="mt-1 flex h-8 w-8 items-center justify-center font-semibold text-gray-900"
						>10</span
					>
				</button>
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
					T <span class="mt-1 flex h-8 w-8 items-center justify-center font-semibold text-gray-900"
						>11</span
					>
				</button>
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
				...
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
					F <span class="mt-1 flex h-8 w-8 items-center justify-center font-semibold text-gray-900"
						>14</span
					>
				</button>
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
					S <span class="mt-1 flex h-8 w-8 items-center justify-center font-semibold text-gray-900"
						>15</span
					>
				</button>
				<button class="flex flex-col items-center pb-3 pt-2" type="button">
