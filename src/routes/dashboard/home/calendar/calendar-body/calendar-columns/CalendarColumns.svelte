...
<div class="h-full w-full bg-white text-sm leading-6 text-gray-500">
	<CalendarColumnsDesktop {dates} on:edit on:create on:move class="hidden sm:block" />
	<CalendarColumnsMobile {dates} on:edit on:create on:move class="block sm:hidden " />
</div>
